...
const faqs = [
  {
    ...
    a: 'Full commercial and residential paint projects. We focus on complete interiors, complete exteriors, and commercial spaces — not single rooms, accent walls, or patch jobs. Minimum job size applies.'
  },
  {
    ...
    <section id="faq" className="py-20 sm:py-28 bg-white border-t border-ink/5">
      ...
      <div className="container-page max-w-3xl">
        ...
        <h2 className="font-display text-3xl sm:text-5xl font-semibold mt-4 leading-tight">
          Questions commercial owners and homeowners actually ask.
        </h2>
        ...
        <p className="mt-10 text-center text-sm text-ink/60">
          ...
          <a href="tel:+17577196269" className="text-brand underline underline-offset-4 hover:text-brand-dark">
            Call Jose at (757) 719-6269
          </a>
          {' '}or email{' '}
          <a href="mailto:jose@alvarezpainters.com" className="text-brand underline underline-offset-4 hover:text-brand-dark">
