...
const faqs = [
  {
    ...
    a: 'Full commercial and residential paint projects. We focus on complete interiors, complete exteriors, and commercial spaces — not single rooms, accent walls, or patch jobs. Minimum job size is $3,500.'
  },
  {
    ...
    <section id="faq" className="py-20 sm:py-28 bg-white border-t border-ink/5">
      ...
      <div className="container-page max-w-3xl">
        ...
        <h2 className="font-display text-3xl sm:text-5xl font-semibold mt-4 leading-tight">
          Questions commercial and residential clients actually ask.
        </h2>
