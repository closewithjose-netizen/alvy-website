...
const faqs = [
  {
    ...
    a: 'Full commercial and residential paint projects. We focus on complete interiors, complete exteriors, and commercial spaces — not single rooms, accent walls, or patch jobs. Full projects only.'
  },
  {
  ...
  },
  {
    ...
    a: "Yes — that's where we shine. We put multiple painters on a big job simultaneously so a 4,000 sq ft repaint doesn't drag on for a month. Detailed scope, daily progress, finished on the date we promised."
  },
  {
    ...
    <section id="faq" className="py-20 sm:py-28 bg-white border-t border-ink/5">
      ...
      <div className="container-page max-w-3xl">
        ...
        <h2 className="font-display text-3xl sm:text-5xl font-semibold mt-4 leading-tight">
          Questions business owners and homeowners actually ask.
        </h2>
